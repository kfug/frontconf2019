<template>
  <div class="">
    ...
    <h2 class="p-session_title">
      <router-link :to="`/handson/${speaker.key}`" class="p-session_titleIcon">
        #
      </router-link>
    ...
    <div class="p-speaker">
      <div class="p-speaker_img" :style="`background-image: url(/images/handson/${speaker.image})`"/>
    ...
    <div style="text-align: center;margin-top: 50px" v-if="isList == false && speaker.guideline">
      <a class="p-btn" :href="speaker.guideline" target="_blank">ハンズオン資料を見る</a>
    </div>
  </div>
</template>
